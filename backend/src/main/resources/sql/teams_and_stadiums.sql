...
(gen_random_uuid(), 'KIA 타이거즈', 'KIA', 'HT', '#EA0029', NOW(), NOW()),
...
(gen_random_uuid(), 'KT 위즈', 'KT', 'KT', '#000000', NOW(), NOW()),
...
(gen_random_uuid(), '이천 야구장', '2000', NOW(), NOW()),
(gen_random_uuid(), '고척 스카이돔', 'GOCHEOK', NOW(), NOW()),
(gen_random_uuid(), '수원 케이티 위즈 파크', 'SUWON', NOW(), NOW()),
(gen_random_uuid(), '인천-문학 SSG 랜더스필드', 'INCHEON', NOW(), NOW()),
...
(gen_random_uuid(), '마산 야구장', 'MASAN', NOW(), NOW()),
